...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//Notice that an Integer can go in to a Double no problem, because it's going from less specific to more specific, so 43 can feat an Integer with a whole number and 43 can feat in to a Double without changing anything because 43 is 43 but if we had the opposite direction trying to put a Double in to an Integer, like this number 1.23 ,we would have to cut of the .23 from it and that wouldn't work because we'll lose data, therefor we can't put Double in to an Integer even if that Double is just 43 because the system doesn't know that it's always be the case.                          
...
//with Doubles we can add, subtract, multiplication, divide, square root, anything we want to do basically we can do with Doubles, so whatever comes to do in math ,we'll see Doubles.               
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
